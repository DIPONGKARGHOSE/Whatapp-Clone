...
public class datacall extends AppCompatActivity {
   ...
   // private MediaPlayer mediaPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datacall);
                ...
                userRef.child(senderUserid).child("Ringing").updateChildren(callingpickupmap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                          //  mediaPlayer.stop();
                            Intent intent=new Intent(datacall.this,datachat.class);
                            intent.putExtra("callerId", "A");
                            intent.putExtra("recipientId","A");
    ...
    protected void onStart() {
        if (ContextCompat.checkSelfPermission(datacall.this,
                android.Manifest.permission.RECORD_AUDIO) !=
                PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission
                (datacall.this, android.Manifest.permission.READ_PHONE_STATE)
                != PackageManager.PERMISSION_GRANTED ) {
            ActivityCompat.requestPermissions(datacall.this,
                                            ...
                                            if(task.isSuccessful()){
                                                userRef.child(senderUserid).child("calling").removeValue()
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                            //    mediaPlayer.stop();
                                                                Intent intent = new Intent(datacall.this, Setting.class);
