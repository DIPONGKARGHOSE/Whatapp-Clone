    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, int i)
    {
        ...
        if (fromMessageType.equals("text"))
        {
            ...
            messageViewHolder.messageSenderPicture.setVisibility(View.VISIBLE);
              Picasso.get().load(messages.getMessage()).placeholder(R.drawable.profile).into(messageViewHolder.messageSenderPicture);
            }
            else{
                messageViewHolder.receiverProfileImage.setVisibility(View.VISIBLE);
                messageViewHolder.messageReceiverPicture.setVisibility(View.VISIBLE);
                Picasso.get().load(messages.getMessage()).placeholder(R.drawable.profile).into(messageViewHolder.messageReceiverPicture);
            }
